...
const Audio_ = {
  ...
  speak(text) {
    ...
    u.lang = "ja-JP";
    u.rate = Number(localStorage.getItem("kotoba.ttsRate") || 0.85);
  ...
  setRate(rate) {
    localStorage.setItem("kotoba.ttsRate", String(rate));
  },
  getRate() {
    return Number(localStorage.getItem("kotoba.ttsRate") || 0.85);
  },
};
